...
public interface WfService extends Remote {
     ...
     * 'mapContextInicial'.
     *
     * @param nomeProcesso       Nome do Workflow
     ...
     *
     * @param siglaProcedimento Sigla do procedimento a ser consultado
     ...
     *
     * @param codigoDocumento Codigo do ducumento das actions que serão executadas.
