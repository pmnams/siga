...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `EX_DOCUMENTO_BLOCK_UPD` BEFORE UPDATE ON `ex_documento` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 /*!50003 TRIGGER `EX_DOCUMENTO_BLOCK_DEL` BEFORE DELETE ON `ex_documento` FOR EACH ROW BEGIN
