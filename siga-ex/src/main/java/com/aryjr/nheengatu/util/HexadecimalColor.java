...
public class HexadecimalColor {
	 ...
	 */
	public static BaseColor hexa2Color(final String corhexa) {
		int rgb =  Color.decode(corhexa).getRGB();
		return new BaseColor(rgb);
	}
	 ...
	 *            Objeto color.
	 */
	public static String color2Hexa(final BaseColor cor) {
