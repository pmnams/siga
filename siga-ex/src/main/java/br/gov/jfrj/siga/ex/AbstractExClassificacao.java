...
@MappedSuperclass
@NamedQueries({
        @NamedQuery(name = "consultarExClassificacaoComExcecao", query = "FROM ExClassificacao cl where cl.codificacao like :mascara and cl.codificacao != :exceto and cl.hisAtivo = 1 order by cl.descrClassificacao"),
...
public abstract class AbstractExClassificacao extends HistoricoAuditavelSuporte
    ...
    public boolean equals(final Object rhs) {
        if (!(rhs instanceof ExClassificacao))
            return false;
        ...
        if ((this.getIdClassificacao() == null ? that.getIdClassificacao() == null
            ...
            return this.getDescrClassificacao() == null ? that
    ...
    public void setExModeloSet(final Set<ExModelo> modeloSet) {
