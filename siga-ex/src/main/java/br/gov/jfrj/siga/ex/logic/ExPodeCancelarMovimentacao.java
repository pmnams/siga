    ...
    protected Expression create() {
        ...
        return And.of(
                ...
                NAnd.of(
                        ...
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.TORNAR_SEM_EFEITO),
                ...
                NOr.of(
                        ...
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.INCLUSAO_EM_EDITAL_DE_ELIMINACAO),
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.RECEBIMENTO),
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.PENDENCIA_DE_ANEXACAO),
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.RECEBIMENTO),

                        // Não deixa cancelar assinatura
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.REGISTRO_ASSINATURA_DOCUMENTO),
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.ASSINATURA_DIGITAL_DOCUMENTO),
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.ASSINATURA_COM_SENHA),
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.ASSINATURA_DIGITAL_MOVIMENTACAO),
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.CONFERENCIA_COPIA_DOCUMENTO),
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.ASSINATURA_MOVIMENTACAO_COM_SENHA),
                        new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.CONFERENCIA_COPIA_COM_SENHA),
                ...
                NAnd.of(
                        ...
                        Or.of(
                                new ExMovimentacaoRefEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.REGISTRO_ASSINATURA_DOCUMENTO),
                                new ExMovimentacaoRefEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.ASSINATURA_DIGITAL_DOCUMENTO)
                        )
                ),

                // Não deixa cancelar algum tipo se não for o cadastrante
                If.of(
                        Or.of(
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.TRANSFERENCIA),
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.TRANSFERENCIA_EXTERNA),
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.DESPACHO_INTERNO_TRANSFERENCIA),
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.DESPACHO_TRANSFERENCIA_EXTERNA),
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.DESPACHO_TRANSFERENCIA),
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.RECEBIMENTO_TRANSITORIO),
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.CONCLUSAO),
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.REGISTRO_ASSINATURA_DOCUMENTO),
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.ASSINATURA_DIGITAL_DOCUMENTO),
                                new ExMovimentacaoEDoTipo(exUltMovNaoCanc, ExTipoDeMovimentacao.SOLICITACAO_DE_ASSINATURA)
                        ),
                ...
                NAnd.of(
                        ...
                        NOr.of(
                                ...
                                And.of(
                                        new ExMovimentacaoEDoTipo(ultimaMovimentacaoDaReferencia, ExTipoDeMovimentacao.ANOTACAO),
                ...
                Or.of(
                        ...
                        // no DJE
                        And.of(
                                new ExMovimentacaoEDoTipo(ultimaMovimentacaoDaReferencia, ExTipoDeMovimentacao.AGENDAMENTO_DE_PUBLICACAO),
                        ...
                        And.of(
                                ...
                                NAnd.of(
                                        new ExMovimentacaoEDoTipo(ultimaMovimentacaoDaReferencia, ExTipoDeMovimentacao.ARQUIVAMENTO_CORRENTE),
                                        new ExPodeDesarquivarCorrente(mob, titular, lotaTitular)
                                ),
                                NAnd.of(
                                        new ExMovimentacaoEDoTipo(ultimaMovimentacaoDaReferencia, ExTipoDeMovimentacao.ANEXACAO),
                                        new ExPodeCancelarAnexo(mob, exUltMovNaoCanc, titular, lotaTitular)
                                ),

                                new ExPodeMovimentarPorConfiguracao(ExTipoDeMovimentacao.CANCELAMENTO_DE_MOVIMENTACAO, titular, lotaTitular)
                        )
                )
        );
