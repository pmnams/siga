...
public abstract class AbstractExTipoDocumento extends Objeto implements
    ...
    public boolean equals(final Object rhs) {
        if (!(rhs instanceof ExTipoDocumento))
            return false;
        ...
        if ((this.getIdTpDoc() == null ? that.getIdTpDoc() == null : this
            ...
            return this.getDescrTipoDocumento() == null ? that
    ...
    public void setExFormaDocumentoSet(final Set<ExFormaDocumento> exFormaDocumentoSet) {
