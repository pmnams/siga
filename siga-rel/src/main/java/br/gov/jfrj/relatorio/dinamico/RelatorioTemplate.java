...
public abstract class RelatorioTemplate extends RelatorioRapido {
    ...
    protected String obterUrlBrasao(Long idOrgaoUsuario) {
        String pathBrasao = Prop.get("/siga.relat.brasao");

        if (Objects.nonNull(idOrgaoUsuario))
            pathBrasao = Prop.get("/siga.internal.base.url") + "/siga/public/app/orgaoUsuario/" + idOrgaoUsuario + "/brasao";
