    ...
    <siga:pagina titulo="Erro Geral" desabilitarbusca="sim" desabilitarmenu="sim" desabilitarComplementoHEAD="sim"
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <c:set var="msgException" scope="request"
                       value="<pre style='font-size: 8pt;overflow: auto!important;max-height: 100px;'>${exceptionStackGeral}</pre>"/>
                ...
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <strong>Usuário</strong> <c:out value="${cadastrante.lotacao}"/> / <c:out
