                ...
                <div class="row">
                    <div class="col">
                        <div class="card bg-light mb-3">
                            ...
                            <div class="card-body">
                                <i class="fa fa-angle-double-right"></i> <a href="" id="linkDoc" target="_blank">PDF do
                                documento</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-light mb-3">
                            ...
                            <div class="card-body">
                                <c:forEach var="assinatura" items="${assinaturas}" varStatus="loop">
                                    ...
                                    <p class="p-0 m-0"><i class="fa fa-angle-double-right"></i> <a
                                            href="${arqAssinatura}"
                                            target="_blank">${assinatura.descrMov}, ${assinatura.getAssinaturaValida()}</a>
                                    </p>
                                </c:forEach>
