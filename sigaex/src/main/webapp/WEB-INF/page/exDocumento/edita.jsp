...
<%--@elvariable id="mensagem" type="String"--%>
<%--@elvariable id="exDocumentoDTO" type="br.gov.jfrj.siga.vraptor.ExDocumentoDTO"--%>
<%--@elvariable id="ehPublicoExterno" type="boolean"--%>
