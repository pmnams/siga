...
<siga:pagina titulo="Novo Documento">
    <link rel="stylesheet" href="/siga/javascript/hierarchy-select/hierarchy-select.css" type="text/css"
        ...
        <div class="card bg-light mb-3">
            ...
            <div class="card-body">
                <form id="frm" name="frm" theme="simple" method="post" enctype="multipart/form-data" class="mb-0">
                    <input type="hidden" id="idTamanhoMaximoDescricao" name="exDocumentoDTO.tamanhoMaximoDescricao"
                           value="${exDocumentoDTO.tamanhoMaximoDescricao}"/>
                    ...
                    <input type="hidden" name="exDocumentoDTO.criandoSubprocesso"
                           value="${exDocumentoDTO.criandoSubprocesso}"/>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="btn-group hierarchy-select form-control p-0 div-width-min0"
                                     data-resize="auto" id="modelos-select" style="min-width: 0px !important;">
                                    <button type="button" class="btn btn-light dropdown-toggle bg-white"
                                            <c:if test='${podeEditarModelo}'>disabled</c:if>
                                            id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false" data-disabled="true">
                                    ...
                                    <input class="hidden hidden-field" name="exDocumentoDTO.idMod" readonly="readonly"
                                           onchange="alterouModeloSelect()"
                    ...
                    <div class="row ${((fn:length(exDocumentoDTO.tiposDocumento) != 1) or (exDocumentoDTO.tipoDocumento != 'interno_capturado' and podeEditarData) or (fn:length(exDocumentoDTO.listaNivelAcesso) != 1) or (!exDocumentoDTO.eletronicoFixo)) ? '' : 'd-none'}">
                        <div class="col-sm-2 ${(exDocumentoDTO.tiposDocumento).size() != 1 ? '': 'd-none'} ${hide_only_GOVSP}">
                            <div class="form-group">
                                ...
                                <select name="exDocumentoDTO.idTpDoc" onkeypress="presskeySelect(event, this, null)"
                        ...
                        <div class="col-sm-2 ${exDocumentoDTO.tipoDocumento != 'interno_capturado' and podeEditarData? '': 'd-none'}  ${hide_only_GOVSP}">
                            <div class="form-group">
                                ...
                                <input type="text" name="exDocumentoDTO.dtDocString" size="10"
                                       onblur="javascript:verifica_data(this, true);"
                                       value="${exDocumentoDTO.dtDocString}" class="form-control campoData"
                                       autocomplete="off"/>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <c:choose>
                                    <c:when test="${exDocumentoDTO.eletronicoFixo}">
                                        <input type="hidden" name="exDocumentoDTO.eletronico" id="eletronicoHidden"
                                               value="${exDocumentoDTO.eletronico}"/>
                                    ...
                                    <c:otherwise>
                                        <input type="radio" class="mt-4" name="exDocumentoDTO.eletronico"
                                               id="eletronicoCheck1" value="1" onchange="javascript:setFisico();"
                                        ...
                                        <input type="radio" class="mt-4 ml-2" name="exDocumentoDTO.eletronico"
                                               id="eletronicoCheck2" value="2" onchange="javascript:setFisico();"
                                               <c:if test="${exDocumentoDTO.eletronicoFixo}">disabled</c:if>
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="exDocumentoDTO.numExtDoc" size="16" maxLength="32"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="exDocumentoDTO.numAntigoDoc" size="16" maxLength="32"
                                           value="${exDocumentoDTO.numAntigoDoc}" class="form-control"/>
                                    <small class="form-text text-muted">(informar o número do documento no antigo
                                        sistema de controle de expedientes ou de
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <siga:selecao titulo="Documento Pai:" propriedade="mobilPai"
                                              inputName="exDocumentoDTO.mobilPai"
                                              tema="simple" modulo="sigaex"
                                              desativar="${exDocumentoDTO.desativarDocPai}" reler="sim"/>
                            </div>
                        </div>
                    </div>
                    <c:choose>
                                ...
                                <c:choose>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <div class="form-check form-check-inline mt-4">
                                                    ...
                                                    <a class="fas fa-info-circle text-secondary ml-1  ${hide_only_TRF2}"
                                                       data-toggle="tooltip" data-trigger="click"
                                                       data-placement="bottom" title="${documento_help_substituto}"></a>
                                                    <input type="checkbox" name="exDocumentoDTO.personalizacao"
                                    ...
                                    <c:otherwise>
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <input type="text" value="${exDocumentoDTO.subscritorSel.sigla}"
                                                           class="form-control" disabled/>
                                                </div>
                                                <div class="col-sm-8">
                                                    <input type="text" value="${exDocumentoDTO.subscritorSel.descricao}"
                                                           class="form-control" disabled/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-4 ">
                                            <div class="form-group">
                                                <div class="form-check form-check-inline mt-1">
                                                    <input type="checkbox"
                                                           name="exDocumentoDTO.podeIncluirSubscrArvoreDocs"
                                                           id="exDocumentoDTO.podeIncluirSubscrArvoreDocs"
                                                           class="form-check-input ml-3"
                                                           <c:if test="${exDocumentoDTO.podeIncluirSubscrArvoreDocs}">checked</c:if>/>
                                                    <label class="form-check-label"
                                                           for="exDocumentoDTO.podeIncluirSubscrArvoreDocs">Acessar
                        ...
                        <div class="row  js-siga-sp-documento-analisa-alteracao">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <siga:selecao propriedade="titular" inputName="exDocumentoDTO.titular" tema="simple"
                                                  modulo="siga"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <input type="hidden" name="exDocumentoDTO.nmFuncaoSubscritor" maxlength="128"
                           id="frm_nmFuncaoSubscritor" value="${exDocumentoDTO.nmFuncaoSubscritor}"/>
                        ...
                        <div class="row ${hide_only_GOVSP}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <c:when test='${exDocumentoDTO.tipoDestinatario == 1}'>
                                        ...
                                        <label>&nbsp;&nbsp;&nbsp;</label>
                                        <siga:selecao propriedade="destinatario" inputName="exDocumentoDTO.destinatario"
                                                      tema="simple" idAjax="destinatario1" reler="ajax" modulo="siga"/>
                                        <!-- idAjax="destinatario" -->
                                    </c:when>
                                    <c:when test='${exDocumentoDTO.tipoDestinatario == 2}'>
                                        ...
                                        <siga:selecao propriedade="lotacaoDestinatario"
                                                      ...
                                                      idAjax="destinatario2" reler="ajax" modulo="siga"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <label>&nbsp;&nbsp;&nbsp;</label>
                                    <input type="text" name="exDocumentoDTO.nmOrgaoExterno" size="120" maxLength="256"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col col-xl-4 col-lg-12">
                                            <select id="preenchimento" name="exDocumentoDTO.preenchimento"
                                                    onchange="javascript:carregaPreench()"
                                                    class="form-control siga-select2">
                                        ...
                                        <div class="col col-xl-8 col-lg-12">
                                            ...
                                            <button type="button" name="btnAlterar" onclick="javascript:alteraPreench()"
                                                    class="btn btn-sm btn-secondary ml-2 p-2" ${desabilitaBtn}>
                                                <i class="far fa-edit"></i>
                                                <span class="${hide_only_GOVSP}">Alterar</span>
                                            </button>
                                            <button type="button" name="btnRemover" onclick="javascript:removePreench()"
                                                    class="btn btn-sm btn-secondary ml-2 p-2" ${desabilitaBtn}>
                                                <i class="far fa-trash-alt"></i>
                                            ...
                                            <button type="button" name="btnAdicionar"
                                                    onclick="javascript:adicionaPreench()"
                                                    class="btn btn-sm btn-secondary ml-2 p-2">
                                                <i class="fas fa-plus"></i>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <siga:span id="descrClassifNovo" depende="forma;modelo;classificacao">
                                        <input type="text" name="exDocumentoDTO.descrClassifNovo" size="80"
                                               value="${exDocumentoDTO.descrClassifNovo}" maxLength="4000"
                                               class="form-control"/>
                                    </siga:span>
                                </div>
                            </div>
                        ...
                        <div class="row  js-siga-sp-documento-analisa-alteracao">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <textarea name="exDocumentoDTO.descrDocumento" cols="80" rows="2"
                                              id="descrDocumento" class="form-control"
                                              oninput="updateURL()">${exDocumentoDTO.descrDocumento}</textarea>
                                    <small class="form-text text-muted">(preencher o campo acima com palavras-chave,
                                        sempre usando substantivos, gênero masculino e
                                        singular).</small>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group" style="margin-bottom:0">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="arquivo" name="arquivo"
                                                   accept="application/pdf" onchange="testpdf(this.form)"
                                                   title="arquivo">
                                            <label class="custom-file-label" for="arquivo"><i
                                                    class="far fa-file-pdf"></i>&nbsp;&nbsp;<fmt:message
                                                    key="usuario.novodocumento.arquivo"/> (limite de 15MB)</label>
                                            <div class="invalid-feedback  invalid-feedback-arquivo">Selecione o
                                                arquivo
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row  js-siga-sp-documento-analisa-alteracao">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="exDocumentoDTO.numExtDoc" size="32" maxLength="32"
                                           value="${exDocumentoDTO.numExtDoc}" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label>Data</label>
                                    <input type="text" name="exDocumentoDTO.dtDocOriginalString" size="10"
                                           onblur="javascript:verifica_data(this, true);"
                                           value="${exDocumentoDTO.dtDocOriginalString}" class="form-control"/>
                                </div>
                            </div>
                            <c:if test='${exDocumentoDTO.tipoDocumento == "externo"}'>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="exDocumentoDTO.numAntigoDoc" size="32" maxLength="34"
                                    ...
                                    <siga:span id="emitente">
                                        <c:choose>
                                            <c:when test='${exDocumentoDTO.tipoEmitente == 1}'>
                                                ...
                                                <siga:selecao propriedade="cpOrgao" inputName="exDocumentoDTO.cpOrgao"
                                                ...
                                                <input type="text" name="exDocumentoDTO.nmSubscritorExt" size="30"
                                                       maxLength="256" value="${exDocumentoDTO.nmSubscritorExt}"
                                                       class="form-control"/>
                                            </c:when>
                    ...
                    <div class="row mt-4">
                        <div class="col-sm-8">
                            <button id="btnGravar" type="button" onclick="javascript: gravarDoc(); return false;"
                                    name="gravar" class="btn btn-primary" accesskey="o"><u>O</u>K
                            </button>
                            <c:if test='${exDocumentoDTO.tipoDocumento == "interno"}'>
                                <c:if test="${not empty exDocumentoDTO.modelo.nmArqMod or exDocumentoDTO.modelo.conteudoTpBlob == 'template/freemarker'}">
                                    <button type="button" name="ver_doc"
                                            ...
                                            class="btn btn-info ${hide_only_GOVSP}" accesskey="v"><u>V</u>er Documento
                                    </button>
                                    <button type="button" name="ver_doc_pdf"
                                            onclick="javascript: popitup_documento(true); return false;"
                                            class="btn btn-info" accesskey="i"><fmt:message
                                            key="documento.btn.ver.impressao2"/></button>
                                    <button type="button" name="voltar" onclick="javascript: history.back();"
                                            class="btn btn-info ${hide_only_TRF2}" accesskey="r">Volta<u>r</u></button>
                                </c:if>
                            </c:if>
                        </div>
                    </div>
