    ...
    <div class="container-fluid content" id="page">
        <div class="row mt-3" id="inicio">
            <div class="col">
                <h2>
                    ...
                    <a class="btn btn-secondary float-right ${hide_only_TRF2}" name="voltar"
                    ...
                    <c:if test="${siga_cliente != 'GOVSP'}">
                        <div class="mt-2">
							...
							<input type="radio" id="radioPDFSemMarcas" name="formato" accesskey="s" value="pdfsemmarcas"
								...
								PDF <u>s</u>em marcas - <a id="pdfsemmarcaslink" accesskey="b"
                ...
                <div id="sidebar" class="w-100">
                    <div class="card-sidebar card bg-light mb-3" id="documentosDossie">
						...
						<span class="titulo-docs">
                            ...
                            <form action="${pageContext.request.contextPath}/app/expediente/doc/reordenar"
                                  id="formReordenarDocs" class="form" method="POST">
                                <input type="hidden" name="idDocumentos" id="inputHiddenIdDocs"/>
                                <input type="hidden" name="sigla" value="${sigla}"/>
                                <button type="submit" class="mt-3 ml-2 btn btn-success btn-sm align-center"
                                        id="btnSalvarOrdenacao" disabled>
                                    <i class="fas fa-check"></i> Salvar
                                </button>
                                <button type="button" class="mt-3 ml-2 btn btn-danger btn-sm align-center"
                                        id="btnCancelarOrdenacao">
                    ...
                    <div class="card-body pl-1 pr-1 pt-0 pb-0  container-tabela-lista-documentos">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank"
                                           ...
                                           href="/sigaex/app/arquivo/exibir?arquivo=${arqNumerado.referenciaPDF}">
                        ...
                        <c:if test="${mob.doc.podeReordenar() && podeExibirReordenacao && mob.doc.temOrdenacao()}">
                            <div class="menu-retornar-para-original">
                                <hr>
                                <form action="${pageContext.request.contextPath}/app/expediente/doc/reordenar"
                                      id="formVoltarDocsParaOrdemOriginal" class="form" method="POST">
                                    <input type="hidden" name="sigla" value="${sigla}"/>
                                    <input type="checkbox" name="isVoltarParaOrdemOriginal"
                                           id="isVoltarParaOrdemOriginal" class="checkbox-oculto" checked disbled/>
        ...
        <div id="right-col" class="col-sm-8 col-lg-9">
                ...
                <div id="linhaBtn" class="mb-2">
                    <div class="input-group d-inline mb-2">
                        <div id="radioBtn" class="btn-group">
                            <a class="btn btn-primary btn-sm active" data-toggle="formato" data-title="html"
                               id="radioHTML" name="formato" value="html" accesskey="h"
                               onclick="toggleBotaoHtmlPdf($(this)); exibir(htmlAtual,pdfAtual,'');">
                                <u>H</u>TML
                            </a>
                            <a class="btn btn-primary btn-sm notActive" data-toggle="formato" data-title="pdf"
                               id="radioPDF" name="formato" value="pdf" accesskey="p"
                               onclick="toggleBotaoHtmlPdf($(this)); exibir(htmlAtual,pdfAtual,'');">
                                <!--  									<a id="pdflink" accesskey="a"> -->
                                <u>P</u>DF
                                <!-- 									</a> -->
                            </a>
                            <a class="btn btn-primary btn-sm notActive" data-toggle="formato" data-title="pdfsemmarcas"
                               id="radioPDFSemMarcas" name="pdfsemmarcas" value="pdfsemmarcas" accesskey="p"
                               onclick="toggleBotaoHtmlPdf($(this)); exibir(htmlAtual,pdfAtual,'semmarcas/');">
                                PDF Sem Marcas
                            </a>
                        </div>
                        <a class="btn-btn-primary btn-sm d-none" id="pdflink" accesskey="a"><u>a</u>brir PDF</a>
                        <a class="btn-btn-primary btn-sm d-none" id="pdfsemmarcaslink" accesskey="b">a<u>b</u>rir
                            PDF</a>
                        <input type="hidden" name="formato" id="radio" value="html">
                    </div>
                    <button type="button" class="btn btn-secondary btn-sm" id="TelaCheia" data-toggle="button"
            ...
            <div id="paipainel" style="margin: 0px; padding: 0px; border: 0px; clear: both;overflow:hidden;">
                <iframe style="visibility: visible; margin: 0px; padding: 0px; min-height: 20em;" name="painel"
                        id="painel" src="" align="right" width="100%"
                        onload="$(document).ready(function () {resize();});redimensionar();removerBotoes();verificarMensagem(this.src)"
