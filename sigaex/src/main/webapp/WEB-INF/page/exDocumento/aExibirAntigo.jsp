                ...
                <c:if test='${popup!="true"}'>
                    ...
                    <siga:links>
                        ...
                        <c:if test="${exibirExplicacao}">
                            <a id="audit"
                               href="javascript:$('.link-tag-hidden').removeClass('d-none');$('.link-tag-no-audit').removeClass('d-none');$('.link-tag-audit').addClass('d-none');"
                               class="btn btn-sm btn-link text-black link-tag link-tag-audit" data-toggle="tooltip"
                               data-html="true" title="Clique para exibir também os botões inativos.">...</a>
                            <a id="no-audit"
                               href="javascript:$('.link-tag-hidden').addClass('d-none');$('.link-tag-audit').removeClass('d-none');$('.link-tag-no-audit').addClass('d-none');"
                               class="btn btn-sm btn-link text-black link-tag link-tag-no-audit d-none"
                               data-toggle="tooltip" data-html="true" title="Clique para ocultar os botões inativos.">...</a>
                        </c:if>
                    </siga:links>
                </c:if>
                                ...
                                <tr class="${mov.classe} ${mov.disabled}">
                                    ...
                                    <td class="text-left">
                                        <siga:selecionado isVraptor="true"
                                                          sigla="${mov.parte.lotaCadastrante.siglaOrgao}${mov.parte.lotaCadastrante.sigla}"
                                    ...
                                    <c:if test="${ (exibirCompleto == 'true')}">
                                        <td class="text-left">
                                            <siga:selecionado isVraptor="true"
                                                              sigla="${mov.parte.lotaSubscritor.siglaOrgao}${mov.parte.lotaSubscritor.sigla}"
                                    ...
                                    <td class="text-left">
                                        <siga:selecionado isVraptor="true"
                                                          sigla="${mov.parte.lotaResp.siglaOrgao}${mov.parte.lotaResp.sigla}"
                                    ...
                                    <c:if test="${exibirCompleto != 'true' and mov.duracaoSpan > 0}">
                                        <td class="duracaoborderbottom text-center bg-white"
                                            rowspan="${mov.duracaoSpan}">
                                                ${mov.duracao}
                                        </td>
                                    </c:if>
                    ...
                    <p class="apensados" style="margin-top: 0pt;">
                        ...
                        <c:forEach var="docFilho" items="${m.expedientesFilhosNaoCancelados}">
                            <c:if test="${!docFilho.doc.cancelado}">
                                ...
                                <a href="${pageContext.request.contextPath}/app/expediente/doc/exibir?sigla=${docFilho.sigla}"
                ...
                <c:if test="${not empty m.apensos}">
                    ...
                    <p class="apensados" style="margin-top: 0pt;">
                        ...
                        <c:forEach var="mobItem" items="${m.apensos}">
                            ...
                            <a href="${pageContext.request.contextPath}/app/expediente/doc/exibir?sigla=${mobItem.sigla}"
                            ...
                            <div class="card-body">
                                ...
                                <c:if test="${not empty docVO.documentosPublicados}">
                                    <p class="apensados" style="margin-top: 0pt;">
                                        ...
                                        <c:forEach var="documentoPublicado" items="${docVO.documentosPublicados}">
                                            <a href="${pageContext.request.contextPath}/app/expediente/doc/exibir?sigla=${documentoPublicado.sigla}"
                                ...
                                <c:if test="${not empty docVO.boletim}">
                                    <p class="apensados" style="margin-top: 0pt;">
                                        ...
                                        <a href="${pageContext.request.contextPath}/app/expediente/doc/exibir?sigla=${docVO.boletim.sigla}"
                                           title="${docVO.boletim.sigla}">
                                                ${docVO.boletim.sigla}
                                        </a>
                                    </p>
                                </c:if>
