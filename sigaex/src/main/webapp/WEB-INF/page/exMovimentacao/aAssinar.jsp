<%@ page pageEncoding="UTF-8" session="false" buffer="64kb" trimDirectiveWhitespaces="true" %>
                ...
                <div class="card bg-light mb-3">
                    ...
                    <div class="card-footer" style="padding-top: 10px;">
                        ...
                        <c:set var="podeAutenticarComSenha"
                               value="${autenticando and f:podeAutenticarComSenha(cadastrante,lotaCadastrante,doc.mobilGeral) }"/>
