                ...
                <form id="frm" action="juntar_gravar" enctype="multipart/form-data" cssClass="form" method="POST">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <label>Data</label>
                                        <input type="text" name="dtMovString" value="${dtMovString}"
                                               onblur="javascript:verifica_data(this, true);" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="form-check form-check-inline mt-4">
                                            <input type="checkbox" theme="simple" name="substituicao"
                                                   value="${substituicao}" onclick="javascript:displayTitular(this);"/>
                                            <label class="form-check-label" for="substituicao">Substituto</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row" id="tr_titular"
                                ...
                                <siga:escolha id="idDocumentoEscolha" var="idDocumentoEscolha">
                                    <siga:opcao id='1' texto="Documento Interno">
                                        ...
                                        <siga:selecao tema='simple' titulo="Documento Pai" propriedade="documentoRef"
                                                      urlAcao="buscar" urlSelecionar="selecionar" modulo="sigaex"/>
                                    </siga:opcao>
                                    <c:if test="${siga_cliente!='GOVSP'}">
                                        <siga:opcao id='2' texto="Documento Externo ao Siga-Doc">
                                            <input type="text" theme='simple' name="idDocumentoPaiExterno"
                                                   value="${idDocumentoPaiExterno}" class="form-control mt-3"/>
                                        </siga:opcao>
                                    </c:if>
                                </siga:escolha>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <a href="${linkTo[ExDocumentoController].exibe()}?sigla=${sigla}"
