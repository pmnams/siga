...
function sbmt() {
    ...
    <div class="container-fluid">
        <form action="${request.contextPath}/app/expediente/mov/referenciar_gravar" enctype="multipart/form-data"
              method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="dtMovString" id="dtMovString" value="${dtMovString}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline mt-4">
                                            <input class="form-check-input" type="checkbox" theme="simple"
                                                   name="substituicao" onclick="javascript:displayTitular(this);"/>
