                    ...
                    <c:if test="${siga_cliente == 'GOVSP'}">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <div class="form-check form-check-inline mt-4">
                                        <input type="checkbox" id="exDocumentoDTO.personalizacao"
                                               name="exDocumentoDTO.personalizacao" class="form-check-input ml-3"
                                               onclick="javascript:displayPersonalizar(this);"/>
                                        ...
                                        <a class="fas fa-info-circle text-secondary ml-1" data-toggle="tooltip"
                                           ...
                                           title="Preencher esse campo se houver a necessidade de trocar as informações cadastrais do cossignatário"></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="div_personalizacao" style="display: none" class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Função</label>
                                    <input type="text" id="funcaoCosignatario" name="funcaoCosignatario" maxlength="125"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="unidadeCosignatario" name="unidadeCosignatario"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="funcaoCosignatario" size="50"
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <input type="button" value="Voltar"
                                   onclick="javascript:location.href='${pageContext.request.contextPath}/app/expediente/doc/exibir?sigla=${sigla}';"
                        </div>
                    </div>
                </form>
            </div>
