                            ...
                            <div class="col col-3">
                                <div class="form-group mb-0">
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                            data-target="#dataModal">Data de Devolução
                                    </button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                                ...
                                                <div class="col col-4">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <input type="text" name="dtDevolucaoMovString"
                                                               ...
                                                               class="form-control campoData" placeholder="dd/mm/aaaa"
                                                               autocomplete="off"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="form-group mb-0">
                                                    <label>ATENÇÃO!! Só preencha o campo data de devolução se o
                                                        documento tiver que retornar para a sua unidade, caso contrário
                                                        após o vencimento o mesmo ficará marcado com o status Aguardando
                                                        devolução fora do prazo, até que retorne para sua
                                                        unidade.</label>
                                                </div>
                                            </div>
                                        </form>
                        ...
                        <div class="row">
                            <div class="col col-3">
                                <div class="form-group mb-0">
                                    <label>Data da devolução</label>
                                    <input type="text" name="dtDevolucaoMovString"
                                           onblur="javascript:verifica_data(this,0);" value="${dtDevolucaoMovString}"
                    ...
                    <c:if test="${siga_cliente != 'GOVSP'}">
                        <div class="row">
                            <div class="col col-12">
                                <small class="form-text text-muted">Atenção: somente preencher a data de devolução se a
                                    intenção for, realmente, que o documento seja devolvido até esta data.</small>
                            </div>
                        </div>
                    </c:if>
                    <div class="row">
                        <div class="col col-9">
                            <div class="form-check form-check-inline mt-3 mb-3">
                                <input class="form-check-input" type="checkbox" name="protocolo" id="protocolo"
                                       value="mostrar" <c:if test="${protocolo}">checked</c:if>/>
                                <label class="form-check-label" for="protocolo"><fmt:message
