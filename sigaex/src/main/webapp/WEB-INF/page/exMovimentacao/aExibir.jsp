                                ...
                                <table border="0" style="width: 100%;">
                                    <tr>
                                        <td>
                                                ...
                                                <c:set
                                                        var="exibemovvariante" scope="request" value=""/>
                                            <c:if
    ...
    <div class="card">
        <div class="card-body">
            ...
            <c:set var="podeAssinarComSenha"
                   value="${f:podeAssinarMovimentacaoComSenha(titular,lotaTitular,mov)}"/>
            <c:set var="podeAutenticarComSenha"
                   value="${f:podeAutenticarMovimentacaoComSenha(titular,lotaTitular,mov)}"/>
            <c:set var="defaultAssinarComSenha"
                   value="${f:deveAssinarMovimentacaoComSenha(titular,lotaTitular,mov)}"/>
            <c:set var="defaultAutenticarComSenha"
                   value="${f:deveAutenticarMovimentacaoComSenha(titular,lotaTitular,mov)}"/>
