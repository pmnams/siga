        ...
        <div class="card bg-light mb-3">
            ...
            <div class="card-body">
                <form action="anexar_gravarmultiplos" method="post" enctype="multipart/form-data" class="form">
                    ...
                    <input type="hidden" id="qtdMaxArquivoAnexadoUpload" name="qtdMaxArquivoAnexadoUpload"
                           value="${qtdMaxArquivoAnexadoUpload}"/>
                    <input type="hidden" id="tamanhoMaxArquivoAnexadoUpload" name="tamanhoMaxArquivoAnexadoUpload"
                           value="${tamanhoMaxArquivoAnexadoUpload}"/>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Arquivo:</label>
                                <input class="form-control" id="arquivo" name="arquivoLista[]" type="file" multiple
                                       accept="application/pdf" onchange="doUpload(this)"/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <c:forEach var="mov" items="${mobilVO.movs}">
                        <c:if test="${(not mov.cancelada)}">
                            <tr class="${mov.classe} ${mov.disabled}">
                                ...
                                <td>${mov.descricao}
                                    <c:if test="${mov.exTipoMovimentacao != 'PENDENCIA_DE_ANEXACAO'}"> ${mov.complemento}</c:if>
