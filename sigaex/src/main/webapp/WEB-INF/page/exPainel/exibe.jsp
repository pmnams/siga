                        ...
                        <c:if
                            ...
                            <a class="btn btn-sm btn-primary float-right" title="Corrige falta de via ou volume"
                               href="corrigeDocSemMobil?documentoRefSel.sigla=${documentoRefSel.sigla}"
                                ${popup?'target="_blank" ':''}><i class="fas fa-file-medical mr-2"></i>Corrige Falta de
                                Via ou Volume</a>
                        </c:if>
                    </div>
                </div>
        ...
        <c:if test="${not empty docVO}">
                            ...
                            <div class="d-box">
                                ...
                                <div class="d-box-content">
                                    <div class="row">
                                        ...
                                        <div class="d-box-col col-md-4">
                                            <div class="font-weight-bold">Espécie</div>
                                            <div class="">${docVO.forma}</div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="d-box-col col-md-12">
                                            <div class="font-weight-bold">Modelo</div>
                                            <div class="">${docVO.modelo}</div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="d-box-col col-md-12">
                                            <div class="font-weight-bold">Classificação</div>
                                            <div class="">${docVO.classificacaoDescricaoCompleta}</div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="d-box-col col-md-4">
                                            <div class="font-weight-bold">Cadastrante</div>
                                            <div class="">${docVO.cadastranteString} ${docVO.lotaCadastranteString}</div>
                                        </div>
                                        <div class="d-box-col col-md-4">
                                ...
                                <div class="d-box-content">
                                    <div class="row">
                                        ...
                                        <div class="d-box-col col-md-2">
                                            ...
                                            <div class="">${docVO.doc.exTipoDocumento.idTpDoc}
                                                - ${docVO.doc.exTipoDocumento.descrTipoDocumento}</div>
                                        </div>
                                        <div class="d-box-col col-md-2">
                                        ...
                                        <div class="d-box-col col-md-4">
                                            ...
                                            <div class="">${docVO.doc.exFormaDocumento.idFormaDoc}
                                                - ${docVO.doc.exFormaDocumento.descrFormaDoc}</div>
                                        </div>
                                    </div>
                                    <div class="row bg-light">
                                        <div class="d-box-col col-12">
                                            <div class="text-sm font-weight-bold">IdMod</div>
                                            <div class="">${docVO.doc.exModelo.idMod}
                                                - ${docVO.doc.exModelo.nmMod}</div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="d-box-col col-md-2">
                                    ...
                                    <div class="row bg-light">
                                        ...
                                        <div class="d-box-col col-md-3">
                                            ...
                                            <div class="">${docVO.doc.cadastrante.idPessoa}
                                                - ${docVO.doc.cadastrante} </div>
                                            <small class="">${docVO.doc.cadastrante.nomePessoa}</small>
                                        </div>
                                        <div class="d-box-col col-md-3">
                                            <div class="text-sm font-weight-bold">IdLotaCadastrante</div>
                                            <div class="">${docVO.doc.lotaCadastrante.idLotacao}
                                                - ${docVO.doc.lotaCadastrante} </div>
                                    ...
                                    <div class="row">
                                        <div class="d-box-col col-md-3">
                                            ...
                                            <div class="">${docVO.doc.subscritor.idPessoa}
                                                - ${docVO.doc.subscritor} </div>
                                            <small class="">${docVO.doc.subscritor.nomePessoa}</small>
                                        </div>
                                        <div class="d-box-col col-md-3">
                                            <div class="text-sm font-weight-bold">IdLotaSubscritor</div>
                                            <div class="">${docVO.doc.lotaSubscritor.idLotacao}
                                                - ${docVO.doc.lotaSubscritor} </div>
                                        ...
                                        <div class="d-box-col col-md-3">
                                            ...
                                            <div class="">${docVO.doc.lotaTitular.idLotacao}
                                                - ${docVO.doc.lotaTitular}</div>
            ...
            <c:forEach var="m" items="${docVO.mobs}" varStatus="loop">
                <c:if
                    ...
                    <div class="card bg-light mb-3">
                        <tags:collapse title="${m.getDescricaoCompletaEMarcadoresEmHtml(cadastrante,lotaTitular)}"
                                                ...
                                                <div class="col-md-3 d-box mr-1">
                                                    <div class="d-box-content">
                                                        <div class="row text-size-7">
                                                            <div class="col-12 font-weight-bold text-left">${marca.cpMarcador.idMarcador}
                                                                - ${marca.cpMarcador.descrMarcador}</div>
                                                        </div>
                                                ...
                                                <div class="d-box-content">
                                                    <div class="row">
                                                        ...
                                                        <div class="d-box-col col-md-6">
                                                            <div class="text-sm font-weight-bold">IdFormaDoc</div>
                                                            <div class="">${docFilho.doc.exFormaDocumento.idFormaDoc}
                                                                - ${docFilho.doc.exFormaDocumento.descrFormaDoc}</div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="d-box-col col-12">
                                            ...
                                            <div class="d-box">
                                                ...
                                                <div class="d-box-content">
                                                    <div class="row">
                                                        ...
                                                        <div class="d-box-col col-md-6">
                                                            <div class="text-sm font-weight-bold">IdFormaDoc</div>
                                                            <div class="">${mobItem.mob.doc.exFormaDocumento.idFormaDoc}
                                                                - ${mobItem.mob.doc.exFormaDocumento.descrFormaDoc}</div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="d-box-col col-12">
