...
<script type="text/javascript">
    submitOk = function () {
        const id = document.getElementById('editar_documentoViaSel_id').value;
        if (id == null || id === "") {
            return;
        }
...
<c:forEach var="idTpFormaDoc" items="${listIdTpFormaDoc}">
    ...
    <div class="card bg-light mb-3">
        <div class="card-header"><a
                href="/sigaex/app/expediente/doc/listar?primeiraVez=sim&idTipoFormaDoc=${idTpFormaDoc}">${idTpFormaDoc == 1 ? "Expedientes" : "Processos Administrativos"} </a>
        </div>
        <div class="card-body">
