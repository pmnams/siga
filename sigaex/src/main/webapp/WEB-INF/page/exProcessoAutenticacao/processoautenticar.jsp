                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="id_number" name="n"
                                               placeholder="Informe o <fmt:message key="usuario.mesavirtual.codigo"/> do Protocolo"
            ...
            <div class="col">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <br/>
                        <p>
                            <u>Ao preencher o <fmt:message key="usuario.mesavirtual.codigo"/> do Protocolo, favor clicar
