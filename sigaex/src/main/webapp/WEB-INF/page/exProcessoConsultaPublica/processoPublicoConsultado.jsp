                ...
                <div class="card-header">
                    <h5>
                        ...
                        <c:if test="${docVO.doc.exNivelAcesso.grauNivelAcesso == 10}">
                            <a href="${request.contextPath}/public/app/arquivoConsultado_stream?jwt=${jwt}&sigla=${sigla}"
                               id="linkDocPdf" target="_blank">
                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach var="mov" items="${movs}">
                                    <tr>
                                        ...
                                        <td colspan="2"
                                            align="left">${mov.lotaCadastrante.nomeLotacao}(${mov.lotaCadastrante.sigla})
                                        </td>
                                        <td colspan="2"
                                            align="left">${mov.lotaResp.nomeLotacao}(${mov.lotaResp.sigla})
                                        </td>
                                    </tr>
                                    <c:choose>
