    ...
    <div class="container-fluid">
        ...
        <div class="card bg-light mb-3">
            ...
            <div class="card-body d-flex">
                <form name="frmRelatorios" id="frmRel" action="/sigaex/app/expediente/rel/relTempoTramitacaoPorEspecie"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <div class="btn-group  float-right">
                                <a href="javascript:visualizarRelatorio('${pageContext.request.contextPath}/app/expediente/rel/relTempoTramitacaoPorEspeciePDF', '0', '0');"
                                ...
                                <div class="dropdown-menu">
                                    <a href="javascript:visualizarCVS('${pageContext.request.contextPath}/app/expediente/rel/relTempoTramitacaoPorEspeciePDF');"
