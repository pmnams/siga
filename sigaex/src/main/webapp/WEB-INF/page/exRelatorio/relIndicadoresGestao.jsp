    ...
    <div class="container-fluid">
        ...
        <div class="card bg-light mb-3">
            ...
            <div class="card-body d-flex">
                <form name="frmRelatorios" action="/sigaex/app/expediente/rel/relIndicadoresGestao" theme="simple"
                      method="get">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <siga:selecao propriedade="lotacao" siglaInicial="${lotacao}" tema="simple"
                                          paramList="buscarFechadas=true" modulo="siga"/>
                        </div>
                        <div class="form-group col-md-4">
                            <label><fmt:message key="usuario.matricula"/></label>
                            <siga:selecao propriedade="usuario" tema="simple" paramList="buscarFechadas=true"
                                          modulo="siga"/>
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            <div class="btn-group  float-right">
                                <a href="javascript:visualizarRelatorio('${pageContext.request.contextPath}/app/expediente/rel/relIndicadoresGestaoPDF');"
                                   class="btn btn-primary float-right" role="button" aria-pressed="true"
                                   style="min-width: 80px;">Exportar PDF</a>
                                <button type="button"
                                        class="btn btn-primary float-right dropdown-toggle dropdown-toggle-split"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="sr-only"></span>
                                </button>
                                <div class="dropdown-menu">
                                    <a href="javascript:visualizarCVS('${pageContext.request.contextPath}/app/expediente/rel/relIndicadoresGestaoCSV');"
                                       class="dropdown-item" role="button" aria-pressed="true">Exportar CSV</a>
                                </div>
                            </div>
                        </div>
                    </div>
