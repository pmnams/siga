...
<siga:pagina titulo="Buscar Classificação Documental" popup="true">
    ...
    <div class="container-fluid">
        <div id="alertFiltros" class="alert alert-warning" role="alert">
            Obrigatório informar <strong>Palavra-chave</strong> e/ou informar algum<strong> Nível de
            Classificação</strong> para realizar a pesquisa.
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nome" id="nome" size="50"
                                       value="${nome}"/>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select nivelSelecionado" id="nivelSelecionado[${i.index}]"
                                            name="nivelSelecionado[${i.index}]"
                                            onchange="javascript:alterarNivel(${i.index});javascript:submit();">
                    ...
                    <div class="row pt-1">
                        <div class="col-12 text-center">
                            <div class="form-group ">
                                ...
                                <br/>
                                <input type="checkbox" name="discriminarVias" id="check" fieldValue="true"
                                       onclick="javascript: submit();" <c:if test="${marcado}">checked</c:if>/>
        ...
        <c:if test="${tamanho gt 0}">
            <div id="containerResult">
                <table class="table table-hover pt-2">
                    ...
                    <tbody>
                    <siga:paginador maxItens="${maxItens}" maxIndices="10" totalItens="${tamanho}" itens="${itens}"
                                    var="classificacao">
