                    ...
                    <div class="tab-pane fade show active" id="content1">
                        <form id="buscar" name="buscar" onsubmit="javascript: return limpaCampos()"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select id="ultMovIdEstadoDoc" name="ultMovIdEstadoDoc"
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label><fmt:message key="usuario.pessoa"/>/<fmt:message
                                                key="usuario.lotacao"/></label>
                                        <select id="ultMovTipoResp" name="ultMovTipoResp"
                                                onchange="javascript:alteraAtendente();" class="form-control">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3 ${pesquisaLimitadaPorData? 'd-none':''}">
                                    <label for="dtDocFinalString">Data Final</label> <input
                                        class="form-control campoData" placeholder="dd/mm/aaaa" autocomplete="off"
                                        type="text" name="dtDocFinalString" id="dtDocFinalString"
                            ...
                            <div class="row" style="${trTipo}" id="trTipo">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Tipo</label>
                                        <select id="tipoForma" name="idTipoFormaDoc"
                                                onchange="javascript:alteraTipoDaForma(false);" class="form-control">
                                            <option value="0">
                                                [Todos]
                                            </option>
                                ...
                                <div class="form-group col-md-3">
                                    <div style="display: inline" id="comboFormaDiv">
                                        <div class="form-group" id="idFormaDocGroup"
                                             onclick="javascript:alteraTipoDaForma(true);"
                                             onfocus="javascript:alteraTipoDaForma(true);">
                                            <label><fmt:message key="documento.label.especie"/> <span
                                                    id="idFormaDoc-spinner"
                                                    class="spinner-border text-secondary d-none"></span></label>
                                ...
                                <div class="form-group col-md-6">
                                    <div style="display: inline" id="comboModeloDiv">
                                        <div class="form-group" id="idModGroup" onclick="javascript:alteraForma(true);"
                                            ...
                                            <label><fmt:message key="documento.modelo3"/> <span id="idMod-spinner"
                                                                                                class="spinner-border text-secondary d-none"></span></label>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select id="anoEmissaoString" name="anoEmissaoString" class="form-control"
                                                onchange="podeDescricao(true)">
                                            <option value="0">
                                                [Todos]
                                            </option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input id="numExpediente" type="text" size="10" name="numExpediente"
                                               value="${numExpediente}"
                            ...
                            <div class="row" style="${trNumOrigDoc}" id="trNumOrigDoc">
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="numExtDoc" value="${numExtDoc}" size="16" value=""
                                               id="numExtDoc" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <c:choose>
                            ...
                            <div class="row" style="${trOrgExterno}" id="trOrgExterno">
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <siga:selecao propriedade="cpOrgao" modulo="siga" titulo="Órgão Externo"
                                                      tema="simple"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="${trNumDocSistAntigo}" id="trNumDocSistAntigo">
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="numAntigoDoc" value="${numAntigoDoc}" size="16"
                                               value="" id="numAntigoDoc" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="form-group">
                                        <label for="numExtDoc" class="label"><fmt:message
                                                key="tela.aBuscar.subscritor"/></label>
                                        <c:choose>
                                            <c:when test="${tipoDocumento == 'externo'}">
                                                <input type="text" label="Subscritor" name="nmSubscritorExt"
                                                       value="${nmSubscritorExt}" size="80" class="form-control"/>
                                            </c:when>
                                            <c:otherwise>
                                                <siga:selecao titulo="Subscritor:" propriedade="subscritor"
                                                              paramList="buscarFechadas=true" tema="simple"
                                                              modulo="siga"/>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                        ...
                                        <c:choose>
                                            <c:when test='${tipoDestinatario == 1}'>
                                                ...
                                                <div id="divNmDestinatario" style="display: none">
                                                    <input type="text" name="nmDestinatario" value="${nmDestinatario}"
                                                           size="80"/>
                                                </div>
                                            </c:when>
                            ...
                            <div class="row ${hide_only_GOVSP}">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <siga:selecao titulo="Classificação:" propriedade="classificacao" tema="simple"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="descrDocumento" id="descrDocumento"
                                               value="${descrDocumento}" size="80" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <button id="btnBuscar" type="button" value="Buscar" class="btn btn-primary"
                                                onclick="submitBusca('${siga_cliente}')">
                                            <span id="buscandoSpinner" class="spinner-border d-none"
                                                  role="status"></span> Buscar
                                        </button>
                                    </div>
                                </div>
                            </div>
