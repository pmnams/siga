                        ...
                        <form id="listar" name="listar"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    <label for="ultMovTipoResp"><fmt:message key="usuario.pessoa"/>/<fmt:message
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" size="10" id="numExpediente" name="numExpediente"
                                           value="${numExpediente}"
                                ...
                                <div class="form-group col-md-3" id="trNumDocSistAntigo"
                                    ...
                                    <label for="numAntigoDoc">Nº do Documento no Sistema
                                        Antigo</label> <input class="form-control" type="text"
                                                              name="numAntigoDoc" value="${numAntigoDoc}" size="16"
                                                              value=""
                                                              id="numAntigoDoc"/>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <label for="tipoCadastrante"><fmt:message key="documento.cadastrante"/></label>
                                    <select
                                ...
                                <div class="form-group col-md-2">
                                    <label for="tipoDestinatario"><fmt:message key="documento.destinatario"/></label>
                                    <select
                            ...
                            <div class="form-row ${hide_only_GOVSP}">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="ordem"><fmt:message key="tela.pesquisa.ordenacao"/></label> <select
                                        class="form-control"
                                ...
                                <div class="form-group col-md-3">
                                    <label for="visualizacao"><fmt:message key="tela.pesquisa.visualizacao"/></label>
                                    <select
