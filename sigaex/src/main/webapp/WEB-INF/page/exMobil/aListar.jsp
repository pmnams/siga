                ...
                <form id="listar" name="listar"
                        ...
                        <div class="form-row">
                            ...
                            />
                                <c:if test="${podePesquisarDescricao && podePesquisarDescricaoLimitada}">
                                    <small>Campo "Descrição" habilitado para pesquisa após o preenchimento dos campos
                                        "Órgão", "Espécie" e "Ano de Emissão"</small>
                                </c:if>
                            </div>
                        </div>
                    </c:if>
                        ...
                        <div class="form-group col-md-3">
                            <div style="display: inline" id="comboFormaDiv">
                                <div class="form-group" id="idFormaDocGroup"
                                    ...
                                    <label><fmt:message key="documento.label.especie"/> <span id="idFormaDoc-spinner"
                        ...
                        <div class="form-group col-md-6">
                            <div style="display: inline" id="comboModeloDiv">
                                <div class="form-group" id="idModGroup" onclick="javascript:alteraForma(true);"
                                    ...
                                    <label><fmt:message key="documento.modelo2"/> <span id="idMod-spinner"
                                                                                        class="spinner-border text-secondary d-none"></span></label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" size="10" name="numExpediente" value="${numExpediente}" maxlength="10"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-row">
