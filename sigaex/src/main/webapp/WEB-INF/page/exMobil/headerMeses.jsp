...
<c:if test="${pesquisaLimitadaPorData}">
    <div id="pesqHeader" class="card-header sticky-top pb-0 pt-1 bg-light">
        ...
        <style>
            ...
            ${formOrigem eq 'busca'?'max-width: 3rem;':''}
            }

            #tabMeses .nav-link.active {
                font-weight: bold;
            }
        ...
        <ul id="tabMeses" class="nav nav-tabs ml-0 small">
            <li class="nav-item ml-0 d-flex align-items-center">
                <div class="input-group input-group-sm">
                    <select id="tabAnos" class="form-control form-select input-group-sm p-0"
            ...
            <li>
                <a class="fas fa-info-circle h6 text-secondary m-2" data-toggle="tooltip" data-trigger="click"
