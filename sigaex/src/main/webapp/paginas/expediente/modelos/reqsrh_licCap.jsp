...
<mod:modelo>
	<mod:entrevista>
		...
		<mod:grupo>
			...
			<br>
			<br>
			<mod:selecao titulo="Acerto Gramatical da Lotação" var="acgr"
				opcoes="no;na" reler="sim" />
		</mod:grupo>
	...
	<mod:grupo titulo="Documentos Anexados">
		...
		<mod:grupo>
			<mod:texto titulo="Instituição Promotora" var="instituto"
				largura="45" />
		</mod:grupo>
		...
		<mod:grupo>
			...
			<mod:selecao titulo="UF" var="uf"
				opcoes="AC;AL;AM;AP;BA;CE;DF;ES;GO;MA;MG;MT;MS;PA;PB;PE;PI;PR;RJ;RN;RO;RR;RS;TO;SC;SE;SP"
				reler="sim" />
			<mod:texto titulo="Telefone" var="telefone" largura="12" />
		</mod:grupo>
		...
		<mod:grupo titulo="Período de Licença:">
			...
			<c:if test="${valorperiodo == 2}">
				<hr style="color: #FFFFFF;" />
				<mod:selecao var="contadorinterv" titulo="Quantidade de Intervalos"
					opcoes="2;3" reler="sim" />
				<br />
				<br>
				<mod:grupo titulo=" Períodos de Licença">
				</mod:grupo>
				<mod:grupo depende="contDependAjax">
		...
		<mod:grupo titulo="Documentos Anexados">
			<mod:grupo>
				<mod:caixaverif titulo="Declaração de matrícula" var="dclmatr"
					reler="sim" />
			</mod:grupo>
			<mod:grupo>
				<mod:caixaverif titulo="Contrato com a instituição" var="ctrinst"
					reler="sim" />
			</mod:grupo>
			<mod:grupo>
			...
			<mod:grupo>
				<mod:caixaverif titulo="Declaração de aluno regular" var="declalu"
					reler="sim" />
			</mod:grupo>
			<mod:grupo>
				<mod:caixaverif
					titulo="Conteúdo programático expedido pela instituição promotora, 
				contendo a carga horária e o período de realização do curso"
					var="contprogram" reler="sim" />
			</mod:grupo>
			<mod:grupo>
				<mod:caixaverif titulo="Folder da instituição" var="folderinst"
					reler="sim" />
			</mod:grupo>
			<mod:grupo>
		...
		<c:set var="dclmatr" value="nao"></c:set>
			...
			<br>
			<br>
			<span style="color: red"> <b>ANUÊNCIA DA CHEFIA IMEDIATA:</b></span>
			<br>
			<span style="color: red"> <b>Declaro estar de acordo com a
					solicitação do servidor e informo não haver outro servidor <br>em
					gozo de licença para capacitação no mesmo período pleiteado
					neste requerimento.
			</b></span>
		</mod:grupo>
	</mod:entrevista>
...
@page {
	...
	margin-bottom: 0.2cm;
		...
		FIM CABECALHO -->
			...
			<c:set var="opt"
				value="${f:classNivPadr(doc.subscritor.padraoReferencia)}" />
			<p style="text-align: center; font-weight: bold; font-size: 8pt;">
			<center>
				<b> ${ilustrissimo} DA SECRETARIA DE RECURSOS HUMANOS</b>
			</center>
			</p>

			<p style="font-family: Arial; font-size: 10pt">
				${doc.subscritor.descricao}, matrícula ${doc.subscritor.matricula},
				${doc.subscritor.cargo.nomeCargo}, ${opt}, do Quadro de Pessoal do
				Tribunal Regional Federal da 2ª Região, ${lotc} ${acgr}
				${doc.subscritor.lotacao.descricao}, ramal ${ramal}, requer, nos
				termos do art.87, da Lei nº 8.112/90, regulamentado pela
				Resolução nº. 05, de 10/03/2008, do Conselho da Justiça Federal
				e Resolução nº. 22/2008, de 03/10/2008, deste Tribunal, licença
				para capacitação para participar do
				<c:choose>
			...
			<p style="font-family: Arial; font-size: 9pt">
				...
				&nbsp;&nbsp;${curso} <br> Período
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
				&nbsp;&nbsp;&nbsp;${datiniciocur} a ${datfimcur}
				&nbsp;&nbsp;&nbsp;___________&nbsp;&nbsp;&nbsp;&nbsp;Carga
				Horária:&nbsp;&nbsp;&nbsp;${cargahora}<br> Instituição
				Promotora
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;${instituto}
				<br>
				<!-- &nbsp;&nbsp;&nbsp;___________&nbsp;&nbsp;&nbsp;&nbsp;Local de Realização&nbsp;&nbsp;  :&nbsp;&nbsp;&nbsp;${local} <br> <br> -->
				Local de
				Realização&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				:&nbsp;&nbsp;&nbsp;${local} <br> Cidade
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;${city}
				...
				<c:if test="${periodo == 2}">
					...
					<c:forEach var="i" begin="1" end="${contadorinterv}">
						<c:set var="dt1"
							value="${requestScope[(f:concat('datinicio',i))]}" />
			...
			<p style="font-family: Arial; font-size: 9pt">
				...
				<br>
				<c:if test="${ outros == 'Sim'}">[X] ${outrostext}</c:if>
				<br>
			</p>

			<p style="font-family: Arial; font-size: 8pt">
				Declaro que todas as informações aqui prestadas são verdadeiras e
				que tenho conhecimento do inteiro teor das Resoluções nº 05/CJF,
				de 03/10/2008 e nº 22/2008, de 03/10/2008, deste Tribunal. Declaro,
				ainda, estar ciente que, ao final da licença para capacitação ora
				requerida, deverei apresentar, no prazo máximo de 30 (trinta) dias,
				o(s) seguintes documentos: <br> a) - No caso de afastamento
				para participação de curso: comprovante de frequência no curso ou
				certificado de conclusão, conforme previsto na Resolução nº
				05/2008 - CJF. <br>b) - Na hipótese de licença para
				conclusão de curso de especialização, mestrado ou doutorado:
				relatório semanal das atividades desenvolvidas, devidamente
				endossado pelo orientador ou coordenador do respectivo curso;
				certificado de conclusão e cópia da monografia/dissertação,
				conforme disposto nas Resoluções nº 05/2008-CJE e nº
				22/2008-TRF2.
			</p>
