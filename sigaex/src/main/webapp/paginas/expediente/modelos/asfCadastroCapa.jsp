...
<mod:modelo>
    <mod:entrevista>
        <mod:grupo titulo="Dados Cadastrais">
            ...
            <mod:grupo>
                ...
                <mod:texto titulo="Seção" largura="5" var="secao"
                           maxcaracteres="5"/>
            ...
            <mod:grupo largura="18">
                <mod:numero titulo="CNH" largura="20" var="cnh" maxcaracteres="20"/>
            </mod:grupo>
        ...
        <mod:grupo titulo="Situação Funcional">
            ...
            <mod:grupo depende="naturezaAtoAjax">
                <c:choose>
                    <c:when
                            test="${naturezaAto == 'Requisição' or naturezaAto == 'Remoção' or
                        ...
                        <mod:grupo>
                            <mod:texto titulo="Cargo" largura="36" var="cargo"
                                       maxcaracteres="36"/>
                            &nbsp;<mod:texto titulo="Órgão Origem" largura="43"
                                             var="orgaoOrigem" maxcaracteres="43"/>
                        </mod:grupo>
                    </c:when>
                    <c:otherwise>
                        <mod:grupo largura="44">
                        ...
                        <mod:grupo>
                            <mod:texto titulo="Cargo" largura="44" var="cargo"
                                       maxcaracteres="44"/>
                            &nbsp;<mod:texto titulo="Padrão" largura="42" var="padrao"
                                             maxcaracteres="42"/>
                        </mod:grupo>
                    </c:otherwise>
                </c:choose>
            ...
            <mod:grupo>
                ...
                <mod:texto titulo="Autoridade" largura="25" var="autoridade"
                           maxcaracteres="25"/>
            </mod:grupo>
        </mod:grupo>
    ...
    <mod:documento>
        ...
        <c:if test="${doc.exTipoDocumento.idTpDoc == 2}">
            ...
            <table align="center" width="60%" border="1" cellspacing="1">
                <tr>
                    <td width="30%" align="center"><br/> <b>Nº no Sistema
                        Antigo</b><br/> <br/></td>
                ...
                <tr>
                    <td align="center"><br/> ${doc.numAntigoDoc}<br/> <br/></td>
                </tr>
        ...
        <table align="center" width="60%" border="1" cellspacing="1">
            <tr>
                <td width="50%" align="center"><br/> <b>Data da abertura</b><br/>
                    <br/></td>
        ...
        <table align="center" width="60%" border="1" cellpadding="4">
            <tr>
                <td width="50%" align="center"><b>Matrícula</b></td>
        ...
        <table width="100%" border="0" bgcolor="#FFFFFF">
            <tr bgcolor="#FFFFFF">
                <td align="left" valign="bottom" width="15%">
                    <c:choose>
                        <c:when test="${not empty doc.lotaTitular.orgaoUsuario.brasao}">
                            <img src="/siga/public/app/orgaoUsuario/${doc.lotaTitular.orgaoUsuario.id}/brasao"
                                 width="65" height="65" alt="brasao"/>
                        </c:when>
                        <c:otherwise>
                            <img src="contextpath/imagens/brasao2.png" width="65" height="65" alt="brasao"/>
                        </c:otherwise>
                    </c:choose>
                </td>
                    ...
                    <table align="left" width="100%">
                        ...
                        <c:if test="${not empty f:resource('modelos.cabecalho.subtitulo')}">
                            <tr>
                                <td width="100%" align="left">
                                    <p
                                            style="font-family: Arial; font-size: 10pt; font-weight: bold;">${f:resource('modelos.cabecalho.subtitulo')}L</p>
                                </td>
                            </tr>
                        </c:if>
                        <tr>
                ...
                <td width="57%" align="center">
                    <p align="center" style="font: bold; font-size: 10pt">
                        <b>ASSENTAMENTO FUNCIONAL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><br/>
                        <font size="2">(CONTRACAPA) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
                    </p>
                </td>
            </tr>
        </table>
        ...
        <table Width="100%" cellpadding="6">
            ...
            <tr>
                <td colspan="2"><b
                    ...
                    &nbsp;${autoridade}</td>
                <td><b style="font-family: Arial Narrow; font-size: 7pt;">VEÍCULO
                    DE PUBLICAÇÃO:</b> &nbsp;${veiculo}</td>
                <td><b style="font-family: Arial Narrow; font-size: 7pt;">DATA
                    DE PUBLICAÇÃO:</b> &nbsp;${publicacao}</td>
