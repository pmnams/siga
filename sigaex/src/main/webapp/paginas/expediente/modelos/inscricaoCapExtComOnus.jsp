...
<mod:modelo>
    ...
    <mod:documento>
        ...
        <table width="100%">
            <tr>
                <td colspan="2" bgcolor="#E8E8E8">SOLICITAÇÃO - Encaminhar com antecedência mínima de 22 (vinte de dois)
                    dias úteis
                </td>
            </tr>
        ...
        <table width="100%">
            <tr>
                ...
                <td width="50%"><font size="2">Cidade: <b>&nbsp;${cidade}</b>&nbsp;&nbsp;&nbsp;UF:<b>${uf}</b></font>
                </td>
            </tr>
            <tr>
        ...
        <table width="100%">
            ...
            <tr>
                <td>
                    <p><font size="2">Justifique por que a proposta escolhida é a que melhor atende às necessidades e a
                        importância dela para as atividades de sua unidade:</font><br>
        ...
        <table width="100%">
            <tr>
                <td align="center" bgcolor="#E8E8E8">Identifique as
                    atividades/tarefas da unidade que serão afetadas pela capacitação.
                </td>
            </tr>
        </table>
        <table width="100%">
        ...
        <table width="100%">
            ...
            <c:forEach var="i" begin="1" end="${serv_indic}">
                <tr>
                    <td><font size="2"><b>${i} </b></font></td>
                    <td><font
                            size="2"><b>${requestScope[f:concat(f:concat('nome',i),'_pessoaSel.descricao')]}</b></font>
                    </td>
                    <td><font
                            size="2"><b>${f:pessoa(requestScope[f:concat(f:concat('nome',i),'_pessoaSel.id')]).cargo.descricao}</b></font>
                    </td>
                    <td><font
                            size="2"><b>${f:pessoa(requestScope[f:concat(f:concat('nome',i),'_pessoaSel.id')]).funcaoConfianca.descricao}</b></font>
                    </td>
                    <td><font
                            size="2"><b>${f:pessoa(requestScope[f:concat(f:concat('nome',i),'_pessoaSel.id')]).lotacao.sigla}</b></font>
                    </td>
                </tr>
            </c:forEach>
        </table>
