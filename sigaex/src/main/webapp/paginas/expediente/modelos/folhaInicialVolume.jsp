    ...
    <mod:documento>
        ...
        <table width="100%" border="0" bgcolor="#FFFFFF">
            <tr bgcolor="#FFFFFF">
                ...
                <td td width="59%" align="center"><p align="right" style=" font: bold; font-size: 16pt"><b>PROCESSO
                    ADMINISTRATIVO</b></td>
            </tr>
        </table>
        </br>
            ...
            <tr>
                <td width=55%>
                    <table border="1" width=100% bordercolor="#000000" bgcolor="#000000" align="left">
                        ...
                        <tr>
                            <td border="0" width=40% bgcolor="#FFFFFF" align="center"><b>Gestor Contratada<br/><br/></b>
                            </td>
                            <td border="0" width=60% bgcolor="#FFFFFF">&nbsp</td>
                        </tr>
                    </table>
        ...
        <table border="1" width=100% bgcolor="#000000">
            ...
            <tr>
                ...
                <td border="0" bgcolor="#FFFFFF">&nbsp</td>
                <td border="0" bgcolor="#FFFFFF">&nbsp</td>
                <td border="0" bgcolor="#FFFFFF" align="center" style=" font-size: 7pt"><b>Exclusividade<b/><br/><b>Válida
                    até<b/></td>
        ...
        <p style="TEXT-INDENT: 2cm">Certifico que, nesta data, iniciei o volume ${mob.numSequencia} do processo em
            epígrafe.</p>
