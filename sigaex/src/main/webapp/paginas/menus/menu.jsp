    ...
    <li class="nav-item dropdown"><a href="javascript:void(0);"
        ...
        <ul class="dropdown-menu">
            ...
            <c:if test="${!ehPublicoExterno && f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA:Sistema Integrado de Gestão Administrativa;DOC:Módulo de Documentos;PESQ:Pesquisar')}">
                <li><a class="dropdown-item"
                       href="/sigaex/app/expediente/doc/listar?primeiraVez=sim"><fmt:message
                        key="documento.pesquisar"/></a></li>
            </c:if>
            ...
            <c:catch>
                <c:if
                    ...
                    <li><a class="dropdown-item"
                           href="/sigaex/app/expediente/mov/transferir_lote"><fmt:message
                            key="documento.transferencia.lote"/></a></li>
                </c:if>
                <c:if
            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    <a class="dropdown-item"
                       href="/sigaex/app/requerente/listar">Cadastro
                        de Requerenetes</a>
                </li>
