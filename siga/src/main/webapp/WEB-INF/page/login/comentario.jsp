...
<div class="d-none d-md-block">
	...
	<c:if test="${f:resource('/siga.external.base.url') == 'http://siga.jfrj.jus.br' or f:resource('/siga.external.base.url') == 'https://siga.jfrj.jus.br' }">
		<hr/>
		...
		<a href="https://siga.jfrj.jus.br/siga-le">${f:resource('/siga.external.base.url')}/siga-le</a>
		</p>
