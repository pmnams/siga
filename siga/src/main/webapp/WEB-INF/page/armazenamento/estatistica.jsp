    ...
    <div class="container-fluid">
        <div class="card mb-3 shadow-lg">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-9">
                        <h5 class="titulo-principal-etapa" id="tituloPrincipalEtapa"><i class="fa fa-chart-line"></i>
                            Estatística de Armazenamento</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body lead">
                                ...
                                <div class="row text-left">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        ...
                                        <div class="progress" style="height: 30px;">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated ${bgClass} "
                                                 role="progressbar" style="width: ${percentualUsed}%"
                                                 aria-valuenow="${percentualUsed}" aria-valuemin="0"
                                                 aria-valuemax="100">
                                                <b>${percentualUsed}%</b>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-sm-12">
                                                <select class="form-control custom-select custom-select-sm float-right"
                                                        id="selectUnidadeDados" onchange="javascript:convertBytes();"
                                                        style="width:80px;">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <a id="btnRefresh" class="btn btn-outline-primary text-center"
                           href="/siga/app/armazenamento/estatistica" title="Atualizar" style="margin-top:50px;"><i
                                class="fa fa-sync-alt"></i> Atualizar</a>
