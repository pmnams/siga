                    ...
                    <div id="mesaDocumentos">
                        <div class="card bg-light mb-3">
                            <div class="card-header"><a
                                    href="/sigaex/app/expediente/doc/listar?primeiraVez=sim&idTipoFormaDoc=1">Expedientes</a>
                            </div>
                            <div class="card-body">
                                <div id='left'>
                        ...
                        <div class="card bg-light mb-3">
                            <div class="card-header"><a
                                    href="/sigaex/app/expediente/doc/listar?primeiraVez=sim&idTipoFormaDoc=2">Processos
            ...
            <c:if
                ...
                <div class="col col-sm-12 col-md-6">
                    ...
                    <c:if
                        ...
                        <div class="card bg-light mb-3">
                            <div class="card-header"><a href="/sigagc/app/estatisticaGeral">Gestão de Conhecimento</a>
                            </div>
                            <div class="card-body">
                                <div id='rightbottom2'>
                                    <jsp:include page="loading.jsp"/>
