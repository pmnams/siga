...
!function s(r, a, l) {
    ...
    2: [function (t, e, o) {
        ...
        var i = t("./svg-utilities"), r = t("./utilities");
        n.prototype.init = function (t, e) {
            ...
            if (e || o) {
                if (e && (!1 === this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(t.a)) ? (t.a = t.d = this.activeState.zoom, e = !1) : (this.updateCache(t), this.options.onZoom(this.getRelativeZoom()))), o) {
                    var n = this.options.beforePan(this.getPan(), {x: t.e, y: t.f}), i = !1, s = !1;
    ...
    4: [function (t, e, o) {
        ...
        var n = t("./uniwheel"), s = t("./control-icons"), r = t("./utilities"), a = t("./svg-utilities"),
            l = t("./shadow-viewport"), u = {
        ...
        i.prototype.init = function (t, e) {
            ...
            if (this.options.zoomEnabled && "none" === this.state) {
                ...
                var i = this.svg.getScreenCTM().inverse(), s = a.getEventPoint(t, this.svg).matrixTransform(i),
            ...
            return this.publicInstance || (this.publicInstance = this.pi = {
                enablePan: function () {
                    ...
                    return {width: o.width, height: o.height, realZoom: o.getZoom(), viewBox: o.viewport.getViewBox()}
                }, destroy: function () {
    ...
    5: [function (t, e, o) {
        ...
        document.documentMode && (s = "ie"), e.exports = {
            ...
            setCTM: function (t, e, o) {
                var n = this, i = "matrix(" + e.a + "," + e.b + "," + e.c + "," + e.d + "," + e.e + "," + e.f + ")";
    ...
    6: [function (t, e, o) {
        ...
        var s, r, a, l, u, h;
        e.exports = (u = [], h = {passive: !(l = "")}, window.addEventListener ? (s = "addEventListener", r = "removeEventListener") : (s = "attachEvent", r = "detachEvent", l = "on"), a = "onwheel" in document.createElement("div") ? "wheel" : void 0 !== document.onmousewheel ? "mousewheel" : "DOMMouseScroll", {
            on: function (t, e, o) {
