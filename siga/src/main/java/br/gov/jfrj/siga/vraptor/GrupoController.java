...
public abstract class GrupoController<T extends CpGrupo> extends
    ...
    /**
     * @param configuracoesGrupo the configuracoesGrupo to set
     */
    ...
    /**
     * @param conteudoConfiguracaoNova the conteudoConfiguracaoNova to set
     */
    ...
    /**
     * @param dscCpTipoGrupo the dscCpTipoGrupo to set
     */
    ...
    /**
     * @param dscGrupo the dscGrupo to set
     */
    ...
    /**
     * @param idConfiguracaoNova the idConfiguracaoNova to set
     */
    ...
    /**
     * @param idCpGrupo the idCpGrupo to set
     */
    ...
    /**
     * @param siglaGrupo the siglaGrupo to set
     */
    ...
    /**
     * @param tipoConfiguracao the tipoConfiguracao to set
     */
    ...
    /**
     * @param tiposConfiguracaoGrupoParaTipoDeGrupo the tiposConfiguracaoGrupoParaTipoDeGrupo to set
     */
    ...
    /**
     * @param tiposDeGrupo the tiposDeGrupo to set
     */
