        ...
        <div class="modal-content">
                ...
                <form id="priorizarForm" name="priorizar" method="POST"
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <option value="MUITO_ALTA" ${pi.prioridade == 'MUITO_ALTA' ? 'selected' : ''}>Muito Alta
                            </option>
                            ...
                            <option value="MUITO_BAIXA" ${pi.prioridade == 'MUITO_BAIXA' ? 'selected' : ''}>Muito
                                Baixa
                            </option>
                        </select>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary"
                        onclick="javascript: document.getElementById('priorizarForm').submit();">Gravar
                </button>
            </div>
        </div>
    </div>
