                            ...
                            <c:choose>
                                <c:when test="${editable}">
                                    <select name="campoValor[${fieldIndex}]" class="form-control"
                                        ...
                                        <option value=""></option>
                                        <option value="1"
                                            ${valor eq '1' or valor eq 'true' ? 'selected' : ''}>Sim
                                        </option>
                                        <option value="0"
                                            ${valor eq '0' or valor eq 'false' ? 'selected' : ''}>Não
                                        </option>
                                    </select>
                                </c:when>
                                <c:otherwise>
                                    <div class="form-control"
                                         readonly>${valor eq '1' or valor eq 'true' ? 'Sim' : valor eq '0' or valor eq 'false' ? 'Não' : ''}&nbsp;
                                    </div>
                                </c:otherwise>
                            </c:choose>
                        </c:when>
        ...
        <div class="row">
            ...
            <div class="col col-auto ${empty td.id ? '' : 'ml-auto'}">
                <button type="submit" name="indiceDoDesvio" value="-1"
                        class="btn btn-${empty td.id ? 'primary' : 'light'}">Salvar
                </button>
            </div>
        </div>
    </c:if>
