                ...
                <div class="col col-md-8">
                    <div class="form-group">
                        <label>Descrição</label> <input type="text" name="descricao"
                                                        ng-model="data.workflow.descricao" size="80"
                                                        class="form-control"/>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col col-md-3">
                    <div class="form-group" id="lotaResponsavel">
                        <label for="lotaResponsavel" title="" class="label">Lotação</label>
                        Resp.
                        <div minlength="1" selected-object="selectedObject"
                             ...
                             template-url="/siga/javascript/angucomplete-alt/custom-template.html">
                        </div>
                ...
                <div class="col col-md-3">
                    <div class="form-group" id="responsavel">
                        <label for="responsavel" title="" class="label">Pessoa</label>
                        Resp.
                        <div minlength="1" selected-object="selectedObject"
                ...
                <div class="col col-12 col-md-8">
                    ...
                    <div ng-repeat="tarefaItem in data.workflow.tarefa" class="row">
                        <div class="col col-auto">
                            <section><label class="label" for="ddm">&nbsp;</label>
                                <div id="ddm" role="group" class="form-controlx btn-group"
                                    ...
                                    <div role="group" class="btn-group dropright">
                                        <button data-toggle="dropdown" aria-expanded="false"
                                                ...
                                                class="btn btn-secondary dropdown-toggle">{{$index + 1}}
                                        </button>
                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                <section
                                        ...
                                        class="col col-12 col-md-3 col-lg-3 form-group">
                                    <label for="ref" title="" class="label">Modelo</label>
                                    <div minlength="1" selected-object="selectedObject"
                                         focus-first="true"
                                ...
                                <section ng-show="tarefaItem.tipo == 'INCLUIR_COPIA'"
                                         class="col col-12 col-md-6 col-lg-6 form-group">
                                    <label for="ref" title="" class="label">Documento</label>
                                    <div minlength="1" selected-object="selectedObject"
                                         focus-first="true"
                                         focus-out="$broadcast(!tarefaItem.ref.originalObject ? 'angucomplete-alt:clearInput' : '');"
                                ...
                                <section
                                        ...
                                        class="col col-12 col-md-3 col-lg-3 form-group">
                                    <label for="ref2" title="" class="label">Preenchimento</label>
                                ...
                                <section
                                        ...
                                        class="form-control"></select></section>
                                <section
                                        ng-if="(tarefaItem.tipo == 'CRIAR_DOCUMENTO' || tarefaItem.tipo == 'AUTUAR_DOCUMENTO') && tarefaItem.param == 'FINALIZAR'"
                                        class="col col-12 col-md-3 col-lg-3 form-group"><label
