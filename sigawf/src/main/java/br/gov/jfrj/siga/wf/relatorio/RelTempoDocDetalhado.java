...
public class RelTempoDocDetalhado extends RelatorioTemplate {
    ...
    public RelTempoDocDetalhado(Map<String, Object> parametros) throws DJBuilderException {
        super(parametros);
    ...
    public Collection<String> processarDados() {
        ...
        Boolean incluirAbertos = parametros.get("incluirAbertos") != null && parametros.get("incluirAbertos").toString().equals("on");
        ...
        List<Tarefa> grupoAtual = new ArrayList<>();
        ...
        for (Tarefa t : tarefas) {
            ...
            if (!t.getNumeroDocumento().equals(ultimoDoc)) {
        ...
        addLinhaFinal(estatisticaGrp, dados);

        return dados;

    }

    private void addLinhaFinal(EstatisticaGrupoRel est, List<String> dados) {
    ...
    private Set<Tarefa> consultarTarefas(WfDefinicaoDeProcedimento pd, Date dataInicialDe, Date dataInicialAte,
        ...
        Set<Tarefa> tarefas = new TreeSet<>(new TarefaComparator());
     ...
     * @author kpf
     */
    static class TarefaComparator implements Comparator<Tarefa> {
