        ...
        <li class="dropdown-submenu"><a href="javascript:void(0);"
            ...
            <ul class="dropdown-menu">
                ...
                <c:if test="${f:podeUtilizarSegundoFatorPin(cadastrante,cadastrante.lotacao) }">
                    <li class="dropdown-submenu"><a href="javascript:void(0);" class="dropdown-item dropdown-toggle">Gerenciar
                        PIN</a>
                        <ul class="dropdown-menu">
                            <c:choose>
                    ...
                    <li class="dropdown-submenu"><a href="javascript:void(0);" class="dropdown-item dropdown-toggle">Armazenamento ${f:resource('/siga.armazenamento.arquivo.tipo')}</a>
                        <ul class="dropdown-menu">
                            <c:if test="${f:podeUtilizarServicoPorConfiguracao(titular,lotaTitular,'SIGA;FE;ARMAZ;ARMAZ_ESTAT:Estatística de Armazenamento;')}">
                                <li><a class="dropdown-item" href="/siga/app/armazenamento/estatistica">Estatísticas</a>
                                </li>
                            </c:if>
                        </ul>
                    </c:if>
