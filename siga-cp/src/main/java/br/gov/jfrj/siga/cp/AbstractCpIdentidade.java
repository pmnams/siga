...
@NamedQueries({
        @NamedQuery(
                ...
                query = "select u from CpIdentidade u, DpPessoa pes"
                        ...
                        + "     and pes.sesbPessoa is not null"
                        + "   )"
                        + "   or ("
        ...
        @NamedQuery(
                name = "consultarIdentidadeCadastranteAtiva",
                query = "select u from CpIdentidade u, DpPessoa pes"
                        + " where ("
                        + "   ("
                        + "     u.nmLoginIdentidade = :nmUsuario"
...
public abstract class AbstractCpIdentidade extends HistoricoAuditavelSuporte {
    ...
    /**
     * @param cpTipoIdentidade the cpTipoIdentidade to set
     */
    ...
    /**
     * @param dscSenhaIdentidade the dscSenhaIdentidade to set
     */
    ...
    /**
     * @param dtCancelamentoIdentidade the dtCancelamentoIdentidade to set
     */
    ...
    /**
     * @param dtCriacaoIdentidade the dtCriacaoIdentidade to set
     */
    ...
    /**
     * @param dtExpiracaoIdentidade the dtExpiracaoIdentidade to set
     */
    ...
    /**
     * @param idCpIdentidade the idCpIdentidade to set
     */
    ...
    /**
     * @param nmLoginIdentidade the nmLoginIdentidade to set
     */
