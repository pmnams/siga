...
public class ArmazenamentoHCP {
    ...
    private final String uri = Prop.get("/siga.armazenamento.arquivo.url");
    private final String uriRest = uri + "rest/";
    private final String usuario = Prop.get("/siga.armazenamento.arquivo.usuario");
    private final String senha = Prop.get("/siga.armazenamento.arquivo.senha");
